...
[![x-cmd/install — datui Code Quality Monitoring Repo Card](https://repo.x-cmd.io/datui.svg)](https://x-cmd.com/install/datui)
...
Total: **87,313** lines of code across **149** files in the top 5 languages.
